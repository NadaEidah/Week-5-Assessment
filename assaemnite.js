...
function calculateTax(salees, tax) {
	var payTax =  salees*tax;
	var netSales = salees-payTax
	if (salees>=tax){
	return "You got"+ salees+" JD from sales, you should pay"+ payTax+" JD for tax and you will have" +netSales+" JD as net sales."
} else {
	return "no"
}
}
...
function stringToCapital(str) {
  ...
  var x= "my is nada";        
 console.log( x.toUpperCase('en-US'));
  
}


console.log(stringToCapital("my is nada"));
// Good luck :)
